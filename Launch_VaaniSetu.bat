@echo off
REM ============================================================================
REM Launch VaaniSetu — 1-Click Interactive Platform Launcher
REM ============================================================================
setlocal
cd /d "%~dp0"
title VaaniSetu - AI Localization Platform for BAIF
color 0F
...
echo.
echo Installation complete. Please re-run Launch_VaaniSetu.bat!
echo.
pause
exit /b 0
...
:open_python_web
start https://www.python.org/downloads/
echo Please install Python (check Add to PATH) and re-run Launch_VaaniSetu.bat.
pause
exit /b 0
